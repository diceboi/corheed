...
export default function GeneraciosKulonbsegekMunkahelyen() {
  return (
    <RegularContainer classname={"lg:py-20 py-8 bg-white"}>
      <div className="flex flex-col lg:gap-16 gap-8 px-4">
        ...
        <div className="flex flex-col gap-6">
          ...
          <Paragraph>
            A munkahelyeken ma már akár 5 generáció is együtt dolgozik, eltérő értékrenddel, kommunikációs stílussal és elvárásokkal. Ezek a különbségek gyakran félreértésekhez és feszültségekhez vezetnek – azonban megfelelő tudással és érzékenyítéssel komoly erőforrássá alakíthatók.
          </Paragraph>
          <Paragraph>
            Ez a tréning segít megérteni a különböző generációk működését, különös tekintettel a legfiatalabb munkavállalók megjelenésére, és gyakorlati szemléletet ad a hatékonyabb együttműködéshez.
          </Paragraph>
        </div>
          ...
          <div className="flex gap-4 items-start">
            ...
            <div className="flex flex-col gap-4">
              ...
              <Paragraph classname={'text-white m-0'}>
                nyitottabb, befogadóbb szemlélet, hatékonyabb kommunikáció és kiegyensúlyozottabb csapatmunka a multigenerációs szervezetekben is.
              </Paragraph>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <Paragraph>
            A vezetők ma egyszerre irányítanak többféle generációt, eltérő motivációkkal, kommunikációs igényekkel és elvárásokkal. A generációs különbségek figyelmen kívül hagyása csökkentheti a teljesítményt, növelheti a fluktuációt és gyengítheti az elköteleződést. Tudatos kezelésük viszont versenyelőnyt jelent.
          </Paragraph>
          <Paragraph>
            Ez a vezetői fókuszú tréning abban támogatja a résztvevőket, hogy magabiztosabban és hatékonyabban vezessenek multigenerációs csapatokat, különös figyelemmel a legfiatalabb munkavállalók megjelenésére.
          </Paragraph>
        </div>
        ...
        <div className="flex flex-col gap-6 bg-[--green] rounded-3xl p-8 lg:p-12">
          <div className="flex gap-4 items-start">
            ...
            <div className="flex flex-col gap-4">
              ...
              <Paragraph classname={'text-white m-0'}>
                nagyobb elköteleződés, csökkenő fluktuáció, hatékonyabb csapatműködés és olyan vezetői szemlélet, amely képes hidat építeni a különböző generációk között.
              </Paragraph>
            </div>
          </div>
        </div>
