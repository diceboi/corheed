...
export default function KapcsolatInner({ sendMail }) {
  ...
  return (
    <section className="relative w-full m-auto px-4 pb-20 pt-96 overflow-hidden">
        <Image src="/kapcsolathero_kapcsolat.png" fill alt="Kapcsolat kép" style={{ objectFit: 'contain', objectPosition: 'top' }} />
      ...
      <div className="container m-auto relative z-10">
        <div className="flex flex-col gap-8 py-8 lg:px-8 lg:w-1/2 m-auto bg-[--green] shadow-md rounded-3xl">
          <div className="flex lg:flex-row flex-col justify-center gap-8 items-baseline z-10">
            <H2 classname={"text-[--white] text-center"}>Írj nekünk</H2>
          </div>
