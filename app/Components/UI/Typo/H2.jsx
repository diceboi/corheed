...
export default function H2({ classname, initial, whileinview, transition, animation, children }) {
  return (
    <motion.h2
      className={`text-[28px] leading-[34px] sm:text-[34px] sm:leading-[40px] md:text-[40px] md:leading-[46px] lg:text-[46px] lg:leading-[52px] font-bold tracking-tight ${classname}`}
