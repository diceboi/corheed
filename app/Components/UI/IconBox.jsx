...
export default function IconBox({ title, text, icon, classname }) {
  return (
    <motion.div
      ...
      className={`flex flex-col lg:items-center items-start ${icon ? 'justify-between' : 'justify-center'} gap-4 bg-[--mint] p-8 rounded-3xl shadow-md lg:min-h-[300px] ${classname}`}>
