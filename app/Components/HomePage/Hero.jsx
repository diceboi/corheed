...
export default function Hero() {
  ...
  return (
    <section className="flex flex-col bg-[--green] w-full pt-20">
      <div className="relative flex lg:flex-row flex-col lg:rounded-b-[90px] overflow-hidden">

        <div className="relative flex flex-col lg:items-end lg:w-1/3 w-full bg-[--white] p-4 lg:h-[50vh] h-[60vh] z-20">
          {slider === "forest" && (
            <Image
